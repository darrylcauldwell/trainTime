...
final class NavigationService {
    ...
    private func getTfLDirections(
        ...
        do {
            ...
            let tflResponse = try JSONDecoder().decode(TfLJourneyResponse.self, from: data)
...
private struct TfLJourneyResponse: Codable {
    let journeys: [TfLJourney]?
}

private struct TfLJourney: Codable {
    let duration: Int?
    let legs: [TfLLeg]?
}

private struct TfLLeg: Codable {
    let duration: Int?
    let distance: Int?
    let mode: TfLMode?
...
private struct TfLMode: Codable {
    let id: String?
    let name: String?
}

private struct TfLRouteOption: Codable {
    let name: String?
}

private struct TfLPoint: Codable {
